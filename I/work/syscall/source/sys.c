...
static int print_children_info(struct task_struct *task){
...
SYSCALL_DEFINE1(process_tree, pid_t, target_pid) {

	printk(KERN_INFO "From syscall process_tree");
	...
	print_task_data(target_task);

	print_children_info(target_task);
